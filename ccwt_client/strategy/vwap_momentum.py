#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Date    : 2018/11/13 18:29    @Author  : xycfree
# @Descript: vwap 动量策略
...
from pyalgotrade.barfeed import csvfeed, Frequency
...
def main(plot):
    ...
    strat = VWAPMomentum(feed, brk, instrument, vwapWindowSize, buyThreshold, sellThreshold)
